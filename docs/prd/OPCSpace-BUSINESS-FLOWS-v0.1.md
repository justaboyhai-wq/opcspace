# OPCSpace 业务流程与动作契约 v0.1

> 本文是 [OPCSpace PRD v0.1](./OPCSpace-PRD-v0.1.md) 的机制附件。
>
...
sequenceDiagram
    ...
    participant B as OPCSpace 后端
    participant C as 物业客服
    participant E as 工程人员
...
|---|---|
| 发起者 | 有预约资格的企业成员 |
| 输入 | 资源、开始/结束时间、人数、用途、设备、联系人、幂等键 |
...
- 签到/核销幂等；设备离线时使用人工登记，恢复后对账而非重复核销。
